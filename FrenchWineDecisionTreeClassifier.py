...
#进行预测
x=[[13.52,3.17,2.72,23.5,97],[12.42,2.55,2.27,22,90],[13.76,1.53,2.7,19.5,132]]#利用3个数据进行测试，即取3个数据作为模型的输入端
mod=model.predict(x)
print(mod)#输出测试的结果，即输出模型预测的结果
dic={'Zinfandel':'仙粉黛','Syrah':'西拉','Sauvignon':'赤霞珠'}
res=[]
for m in mod:
	res.append(dic[m])
print(res)#输出结果对应的中文
